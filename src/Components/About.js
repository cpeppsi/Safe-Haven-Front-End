    ...
    return (
        <div className='container-lg font-nice'>
            ...
            <div  style={{position:'relative'}}>
                ...
                Photo by <a href="https://unsplash.com/photos/q_TH75_MFTc">Erica Magugliani</a> on <a href="https://unsplash.com/s/photos/pet?orientation=landscape&license=free">Unsplash</a>
                </div>
            </div>
            <div style={{
                width:'100%',
